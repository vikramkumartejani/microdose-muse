...
const Banner = () => {
    return (
        <div className='px-4'>
            <div data-aos="fade-up" className='my-[60px] md:my-[120px] relative max-w-[1200px] w-full mx-auto bg-cover bg-bottom rounded-[30px] md:rounded-[52px] py-6' style={{ backgroundImage: "url('/assets/testimonials.jpg')" }}>
