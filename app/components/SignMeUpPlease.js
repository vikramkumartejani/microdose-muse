  ...
  return (
    <div className='w-full imgbg relative  py-32 flex items-center justify-end px-4 md:px-10 xl:px-20'>
      <div className='flex items-center lg:items-start lg:flex-row flex-col gap-16 mb-80 lg:mb-24 xl:gap-32'>
        <Image src='/assets/book1.png' alt='Book' width={413} height={583} className='md:h-[583px] w-[413px] rounded-[15px] shadow-custom -rotate-2'  data-aos="fade-up" />
      ...
      <Image src='/assets/tree.svg' alt='Tree' width={380} height={406} className='absolute bottom-0 left-0'  data-aos="fade-up" />
    </div>
  )
}
