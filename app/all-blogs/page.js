    ...
    return (
        <>
            <div className='pb-[30px] sm:pb-[60px] md:pb-[130px] pt-[130px] w-full px-2 sm:px-4 lg:px-10 xl:px-20 2xl:px-40'>
                <div className='flex items-center justify-center relative w-full max-w-[350px] mx-auto' data-aos="fade-up">
                ...
                <p className='text-[#4C535A] text-center mt-1 font-poppins text-[13px] font-medium' data-aos="fade-up">The Microdose Muse Blog</p>
                    ...
                    <div className='flex lg:flex-col flex-col-reverse gap-3 sm:gap-5 w-full'>
                        ...
                        <div className='w-full rounded-lg shadow-lg overflow-hidden relative group'>
                            ...
                            <div className="absolute bottom-0 w-full px-2.5 sm:px-6 py-4 ">
                                <div  data-aos="fade-up" className='min-w-full flex sm:flex-row flex-col items-center justify-between gap-4'>
                        ...
                        <div className='flex items-center gap-1.5 sm:gap-5'>
                            ...
                            <div className='w-full rounded-lg shadow-lg overflow-hidden relative group'>
                                ...
                                <div className="absolute bottom-0 h-full flex items-end justify-end flex-col px-2.5 sm:px-5 py-4 ">
                                    <div data-aos="fade-up" className='w-full flex lg:items-center justify-between flex-col gap-1'>
