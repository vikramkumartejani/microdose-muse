...
const SingleBlog = () => {
  ...
  return (
    <>
        <div className='overflow-hidden pt-[120px] md:pt-[140px] pb-[40px] md:pb-[89px] w-full px-4 lg:px-20 2xl:px-40'>
            <p className='text-center text-[#454545] text-[28px] sm:text-[40px] leading-normal font-alethia font-normal' data-aos="fade-up">The Essential Guide To  Peaceful Life</p>
            <div>
                <Image  data-aos="fade-left" src='/assets/blog-five.png' alt='singal-blog' width={1284} height={421} className='min-h-[200px] mx-auto w-full my-5 md:my-10' />
                <div className='max-w-[1066px] mx-auto w-full'>
                    <div  data-aos="fade-up" className='flex items-center flex-col justify-center gap-[5px]'>
                    ...
                    <h1 data-aos="fade-up" className='mt-2 text-[#454545] font-alethia text-[20px] sm:text-[42px] font-normal sm:leading-[67px]'>Exploring the Psychedelic Realm: A Journey Through the Mind</h1>
                    <p data-aos="fade-up" className='mt-[10px] sm:mt-[15px] text-[#454545] text-[14px] sm:text-[15px] sm:leading-[24px] font-normal'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                    <p data-aos="fade-up" className='mt-[10px] sm:mt-[24px] text-[#454545] text-[14px] sm:text-[15px] sm:leading-[24px] font-normal'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&apos;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                    <div data-aos="fade-right" className='my-4 sm:my-6 flex items-center gap-[16.5px]'>
                    ...
                    <div className='flex items-center sm:flex-row flex-col gap-5 overflow-x-auto'>
                        <Image src='/assets/image-one.png' alt='image-one' width={523} height={348} className='w-full' data-aos="fade-right"/>
                        <Image src='/assets/image-two.png' alt='image-one' width={523} height={348} className='w-full' data-aos="fade-left"/>
                    </div>
                    ...
                    <Image data-aos="fade-up" src='/assets/image-three.png' alt='image' width={1066} height={348} className='min-h-[200px]' />
                    ...
                    <div data-aos="fade-right" className='mt-4 pb-8 sm:pb-[60px] md:pb-[112px] border-b border-[#D9D9D9] flex items-center gap-3 sm:gap-5'>
