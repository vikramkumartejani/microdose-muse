    ...
    <>
      <div>
        ...
        <div className='w-full bg-image-one py-[50px] sm:py-[60px] text-center px-4'>
          <h2 className='text-[25px] sm:text-[32px] sm:leading-[51px] max-w-[600px] mx-auto font-alethia text-white'>I view my life as before psychedelics, and after psychedelics.</h2>
        </div>
      </div>
