            ...
            <div className='bg-iam-amanda w-full py-[40px] md:py-[80px] relative overflow-hidden'>
                ...
                <div className='relative z-20 w-full text-white px-4 md:px-[40px] lg:px-[100px]'>
                    <div className='flex items-center justify-between gap-10'>
                        <div>
                            <h1 data-aos="fade-up" className='text-[20px] sm:text-[24px] leading-[38px] font-alethia font-normal'>Hi, I’m Amanda (aka: Panda)</h1>
                            <p data-aos="fade-up" className='mt-5 sm:mt-8 font-poppins text-[18px] sm:text-[22px] sm:leading-[33px] font-light max-w-[945px]'>I guide people to imagine, and then live, the magical and expansive path. <b>My offering is combining the extraordinary power of microdosing with mindset and transformation coaching.</b></p>
                            <p data-aos="fade-up" className='mt-2 sm:mt-4 font-poppins text-[18px] sm:text-[22px] sm:leading-[33px] font-light max-w-[945px]'>Through safe and supported microdose protocols, paired with deep, transformative coaching, I help you unlock profound and lasting change in your life.</p>
                        </div>
