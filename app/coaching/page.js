...
const Coaching = () => {
    return (
        <div className='overflow-hidden pt-[80px] w-full'>
            {/* Hero */}
            <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden px-4">
                ...
                <div className="relative z-10 ">
                    <div className=" text-white max-w-[823px] mx-auto text-center" data-aos="fade-up">
            ...
            <div className='bgcommitted-to-helping w-full py-[50px]'>
                <div className='bg-image-five w-full py-[50px] sm:py-[70px] px-4'>
                    <p data-aos="fade-up" className='text-white text-[25px] sm:text-[32px] sm:leading-[51px] font-alethia font-normal max-w-[1000px] mx-auto text-center'>I&lsquo;m committed to helping you balance deep emotional work with intentional actions that create the change you seek.</p>
                </div>
            </div>
